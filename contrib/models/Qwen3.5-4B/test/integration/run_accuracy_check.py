...
"""
Cross-check Qwen3.5-4B accuracy on Neuron against a HuggingFace CPU reference.
...
Usage:
    ...
    python contrib/models/Qwen3.5-4B/test/integration/run_accuracy_check.py \\
...
def load_hf(model_path: str):
    ...
    try:
        ...
        raise RuntimeError(
            "HF Qwen3.5-4B did not load via AutoModelForCausalLM; "
...
def main():
    ...
    ap.add_argument("--compiled-path", default="/tmp/qwen35_4b_traced")
