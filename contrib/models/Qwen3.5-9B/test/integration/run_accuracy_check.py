...
"""
Cross-check Qwen3.5-9B accuracy on Neuron against a HuggingFace CPU reference.
...
Usage:
    ...
    python contrib/models/Qwen3.5-9B/test/integration/run_accuracy_check.py \\
...
def load_hf(model_path: str):
    ...
    try:
        ...
        raise RuntimeError(
            "HF Qwen3.5-9B did not load via AutoModelForCausalLM; "
